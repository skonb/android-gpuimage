 ...
 */
public class GPUImageDualRecordableTextureRenderer extends GPUImageDualTextureRenderer {
    ...
    public GPUImageDualRecordableTextureRenderer() {
        createFile();
    }

    public GPUImageDualRecordableTextureRenderer(GPUImageFilter filter) {
        super(filter);
        createFile();
    }
